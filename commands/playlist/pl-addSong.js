        ...
        try {
            ...
            if (loadType === "playlist") {
                ...
                collector.on('collect', async (i) => {
                    ...
                    await interaction.editReply({ 
                        embeds: [embed.setDescription(`\`✔\` |  Added **[${track.info.title}](${track.info.uri})** to playlist \`${selectedPlaylistName}\`.`).setFooter({ iconURL: "https://files.cloudkuimages.guru/images/E1e6Fpdq.jpg", text: "DanXMusic" })],
                        components: [] 
                    });
                    collector.stop();
                });
